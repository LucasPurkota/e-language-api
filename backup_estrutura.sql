...
--
-- Name: aluno_unidade_aula; Type: TABLE; Schema: public; Owner: e_language
--

CREATE TABLE public.aluno_unidade_aula (
    aluno_unidade_aula_id uuid NOT NULL,
    aluno_unidade_id uuid NOT NULL,
...
ALTER TABLE public.aluno_unidade_aula OWNER TO e_language;
...
--
-- Name: password_reset_token; Type: TABLE; Schema: public; Owner: e_language
--
...
CREATE TABLE public.password_reset_token (
    ...
    user_usuario_id uuid
);


ALTER TABLE public.password_reset_token OWNER TO e_language;

--
-- Name: password_reset_token_id_seq; Type: SEQUENCE; Schema: public; Owner: e_language
--
...
--
-- Name: aluno_unidade_aula aluno_unidade_aula_pkey; Type: CONSTRAINT; Schema: public; Owner: e_language
--

ALTER TABLE ONLY public.aluno_unidade_aula
    ADD CONSTRAINT aluno_unidade_aula_pkey PRIMARY KEY (aluno_unidade_aula_id);
...
--
-- Name: password_reset_token password_reset_token_pkey; Type: CONSTRAINT; Schema: public; Owner: e_language
--
...
--
-- Name: aluno_unidade_aula aluno_unidade_aula_fk; Type: FK CONSTRAINT; Schema: public; Owner: e_language
--

ALTER TABLE ONLY public.aluno_unidade_aula
    ADD CONSTRAINT aluno_unidade_aula_fk FOREIGN KEY (aluno_unidade_id) REFERENCES public.aluno_unidade(aluno_unidade_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: aluno_unidade_aula aluno_unidade_aula_fk2; Type: FK CONSTRAINT; Schema: public; Owner: e_language
--

ALTER TABLE ONLY public.aluno_unidade_aula
    ADD CONSTRAINT aluno_unidade_aula_fk2 FOREIGN KEY (aula_id) REFERENCES public.aula(aula_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: aluno_unidade_aula aluno_unidade_aula_fk3; Type: FK CONSTRAINT; Schema: public; Owner: e_language
--

ALTER TABLE ONLY public.aluno_unidade_aula
    ADD CONSTRAINT aluno_unidade_aula_fk3 FOREIGN KEY (status_id) REFERENCES public.status(status_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: password_reset_token fk5mowipjhbun8jglma6284af6u; Type: FK CONSTRAINT; Schema: public; Owner: e_language
--

ALTER TABLE ONLY public.password_reset_token
    ADD CONSTRAINT fk5mowipjhbun8jglma6284af6u FOREIGN KEY (user_usuario_id) REFERENCES public.usuario(usuario_id);
